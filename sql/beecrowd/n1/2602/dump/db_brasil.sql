CREATE DATABASE  IF NOT EXISTS `db_brasil` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `db_brasil`;
-- MariaDB dump 10.19  Distrib 10.4.21-MariaDB, for Win64 (AMD64)
--
-- Host: 127.0.0.1    Database: db_brasil
-- ------------------------------------------------------
...
-- Dump completed on 2022-09-27 10:45:08
